            ...
            <v-layout row wrap>
              <v-flex xs6 sm6>
                ...
                <v-list two-line>
                  <v-list-tile>
                    <v-list-tile-action>
                      <v-checkbox v-model="facets" value="erj"/>
                    </v-list-tile-action>
                    <v-list-tile-content>
                  ...
                  <v-list-tile>
                    <v-list-tile-action>
                      <v-checkbox v-model="facets" value="openres"/>
                    </v-list-tile-action>
                    <v-list-tile-content>
              ...
              <v-flex xs6 sm6>
                ...
                <v-list two-line>
                  <v-list-tile>
                    <v-list-tile-action>
                      <v-checkbox v-model="facets" value="err"/>
                    </v-list-tile-action>
                    <v-list-tile-content>
                  ...
                  <v-list-tile>
                    <v-list-tile-action>
                      <v-checkbox v-model="facets" value="breathe"/>
                    </v-list-tile-action>
                    <v-list-tile-content>
...
export default {
  ...
  computed: {
    ...mapGetters("search", ["filters", "counters"]),
  ...
  methods: {
    ...mapActions("search", ["setFilters", "searchAll"]),

    reset() {
      this.setFilters({
        type: "journals",
        filtering: false,
        payload: ["erj", "err", "breathe", "openres"]
      });
      this.searchAll();
    }
  }
