  ...
  <v-card>
    ...
    <v-card-title>
      <div>
        ...
        <v-list two-line v-if="post.authors
            || post.chairs
          ...
          <v-list-tile v-if="post.authors">
            ...
            <v-list-tile-content>
              <v-list-tile-title><span v-html="post.authors"></span></v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
          ...
          <v-list-tile v-if="post.chairs">
            ...
            <v-list-tile-content>
              <v-list-tile-title><span v-html="post.chairs"></span></v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>

          <v-list-tile v-if="post._source.organisers">
            <v-list-tile-content>
              <v-list-tile-title><span v-html="post._source.organisers"></span></v-list-tile-title>
          ...
          <v-list-tile v-if="post._source.faculty">
            <v-list-tile-content>
              <v-list-tile-title><span v-html="post._source.faculty"></span></v-list-tile-title>
          ...
          <v-list-tile v-if="post._source.speakerText">
            ...
            <v-list-tile-content>
              <v-list-tile-title><span v-html="post._source.speakerText"></span></v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
        </v-list>
        <v-list v-if="post._source.aims || post._source.audience">
          ...
          <v-list-tile v-if="post._source.aims">
            ...
            <v-list-tile-content>
              <v-list-tile-title><span v-html="post._source.aims"></span></v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
          ...
          <v-list-tile v-if="post._source.audience">
            ...
            <v-list-tile-content>
              <v-list-tile-title><span v-html="post._source.audience"></span></v-list-tile-title>
            </v-list-tile-content>
          </v-list-tile>
