          ...
          <v-container fluid v-show="show">
            <v-layout row wrap>
              ...
              <v-subheader>Congress indices</v-subheader>
                <v-list-tile>
                  <v-list-tile-action>
                    <v-checkbox v-model="facets" value="congress-2018"></v-checkbox>
                  </v-list-tile-action>
                  <v-list-tile-content>
                ...
                <v-list-tile>
                  <v-list-tile-action>
                    <v-checkbox v-model="facets" value="congress-2017"></v-checkbox>
                  </v-list-tile-action>
                  <v-list-tile-content>
                ...
                <v-list-tile>
                  <v-list-tile-action>
                    <v-checkbox v-model="facets" value="congress-2016"></v-checkbox>
                  </v-list-tile-action>
                  <v-list-tile-content>
                ...
                <v-list-tile>
                  <v-list-tile-action>
                    <v-checkbox v-model="facets" value="congress-2015"></v-checkbox>
                  </v-list-tile-action>
                  <v-list-tile-content>
              ...
              <v-flex xs6 sm6>
                <v-list two-line subheader>
                  ...
                  <v-list-tile>
                    <v-list-tile-action>
                      <v-checkbox v-model="typeFacets" value="session*"></v-checkbox>
                    </v-list-tile-action>
                    <v-list-tile-content>
                  ...
                  <v-list-tile>
                    <v-list-tile-action>
                      <v-checkbox v-model="typeFacets" value="presentation*"></v-checkbox>
                    </v-list-tile-action>
                    <v-list-tile-content>
...
export default {
  ...
  computed: {
    ...
    facets: {
      ...
      set (v) {
        this.setIndices({
          type: 'congress',
          payload: v.length > 0 || v[0] === 'congress-2018' ? v : ['congress-2018'],
  ...
  methods: {
    ...
    reset () {
      this.setFilters({ type: ['congress-2018'], filtering: false, payload: [] })
      this.searchAll()
    }
  }
}
